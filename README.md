...
| disabled      | `function`  |               | Disable Editable cells conditionally. Entire columns can be disabled using options.dsabled. If both are provided, this func will have high priority  `(row, dataKey) => bool`|
